...
import { AlignJustifyIcon, DotIcon, DownloadIcon, UsersIcon, DiscAlbumIcon, PlayCircle, PlayIcon } from 'lucide-react';
                                                    ...
                                                    {track.streamable && (
                                                        <div className='flex flex-row gap-2'>
                                                            ...
                                                            <Button
                                                                size='icon'
                                                                variant='ghost'
                                                                className='md:group-hover:flex md:hidden justify-center aspect-square h-6 w-6 hover:bg-transparent'
